...
const renderContent = {
    ...
    2: (<InfoBox text='Worked on many projects and picked up many skills along the way.' link='/about' btnText='Learn more' />),
    3: (<InfoBox text='Led multiple projects to success. Curious about the impact?' link='/projects' btnText='Visit my portfolio!' />),
